    ...
    >
      ...
      <div className="w-full max-w-[500px] mx-auto relative z-10">
        ...
        <div className="bg-white/5 backdrop-blur-2xl border border-white/10 rounded-[40px] p-8 md:p-12 shadow-2xl">
          ...
          <a href="http://localhost:5000/auth/login/google" className="w-full flex items-center justify-center gap-3 bg-white/5 border border-white/10 text-[#f9f5ef] px-8 py-4 rounded-full text-sm font-black uppercase tracking-widest hover:bg-white/10 hover:border-white/20 transition-all shadow-inner">
